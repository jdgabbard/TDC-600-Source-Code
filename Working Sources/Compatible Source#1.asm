...
;						WORKING SOURCE CODE
;
;	Is tested compatible with MSX1 (Casio MX-10) on 11/14/2021 at 10:24am
;
;
;-------------------------------------------------------------------------------
; DOS1.MAC
...
_SECBUF equ     0F34DH                  ; pointer to sectorbuffer, can be used by the disk hardware driver
...
C655C:  OUT     (0A8H),A                ; make secundairy slotregister accessable (switch page 3)
        LD      A,(YFFFF)
        CPL
...
?6567:  OUT     (0A8H),A                ; make secundairy slotregister accessable (switch page 3)
        LD      A,L
        JR      J656F                   ; change secundairy slotregister, restore primairy slotregister and quit
...
?656C:  OUT     (0A8H),A                ; make secundairy slotregister accessable (switch page 3)
        LD      A,E
J656F:  LD      (YFFFF),A
        LD      A,B
        OUT     (0A8H),A
